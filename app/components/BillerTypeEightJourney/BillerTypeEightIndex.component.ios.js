...
import styles from './BillerTypeEightIndex.style';
...
class BillerTypeEightIndex extends Component {
  static propTypes = {
  ...
  render () {
    ...
    const subscriberNoKey = result(biller, 'billerPreferences.paymentSubscriberNoKey', '') || result(biller, 'billerPreferences.purchaseSubscriberNoKey', '');
    const subscriberNoText = language[generateLanguageGenericBiller(subscriberNoKey)];
    const subscriberNoPlaceHolderText = language[generateLanguageGenericBillerPlaceHolder(subscriberNoKey)];
    return (
...
export default BillerTypeEightIndex;
