...
import styles from './BillerTypeEightConfirmation.style';
...
export default class BillerTypeEightConfirmation extends Component {
  static propTypes = {
  ...
  render () {
    const {accountNo = {}, resData = {}, dataDetail = [], isUseSimas,
      biller = {}, handleSubmit, goToCoupon, couponUse,
