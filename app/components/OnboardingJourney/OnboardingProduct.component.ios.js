...
import {result, lowerCase, startsWith} from 'lodash';
...
class Offers extends React.Component {
  ...
  renderProduct = (data = []) => {
    ...
    return (
      <Touchable style={styles.containerInnerProductSeall} onPress={isLogin ? productGoTo : gotoEasyPin(productName)}>
