...
import styles from './BillerTypeOnePayment.styles';
...
class BillerTypeOnePayment extends React.Component {
  static propTypes ={
  ...
  render () {
    const {formValues, billDetails = {}, biller = {}, invalid = false, handleSubmit = noop, billerAccount, billerAccountWithCC, isBillerBlacklisted, moreInfoBL, disabled, errors, isLogin, defaultAccount, isAutoSwitchToogle, switchAccountToogleBE, toogleCheckbox, checked, isAutoDebit, isADebit, autoDebitEnabled} = this.props;
    ...
    const errorText = result(errors, 'accountNo', '') ||  result(errors, 'billAmount', '');
...
export default BillerTypeOnePayment;
