...
import {View, Text, Keyboard, PermissionsAndroid, ScrollView, Image} from 'react-native';
...
class SearcheableListTrf extends Component {
  ...
  render () {
    const {btnNewAcc = '', labelTitlle = '',
      ...
      placeholderEmail, placeholderPhone, placeholderBiFast, textKeyBiFast, SetBiFast, dtActionName, dtActionNameHistory} = this.props;
            ...
            <View style={onNextClick ? styles.inputAcc : styles.inputWithPaddingHorizontalAcc}>
              {isCardless ?
                <View style={styles.textInputContainerPadding}>
                  ...
                  />
                  <Touchable onPress={this.getContact} style={styles.iconContact}>
