...
import styles from './BillerTypeNineConfirmation.style';
...
export default class BillerTypeNineConfirmation extends Component {
  static propTypes = {
  ...
  render () {
    const {resData = {}, denomination = {}, accountNo = {}, dataDetail = [], isUseSimas,
      biller = {}, handleSubmit, goToCoupon, couponUse, isLogin, showFavorite = noop,
      favoriteBill, removeFavorite, billerFavorite, isAutoDebit, autoDebitDate, isADebit} = this.props;
      ...
      <ScrollView keyboardShouldPersistTaps='handled' contentContainerStyle={styles.containerContent} style={styles.container}>
        ...
        <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
          <View>
            ...
            <View>
              <Text style={styles.rightItemHeader}>{language.GENERIC_BILLER__TOTAL_AMOUNT}</Text>
              <Text>{result(denomination, 'id', '')}</Text>
            </View>
          </View>
          {isRegular ?
            <View>
