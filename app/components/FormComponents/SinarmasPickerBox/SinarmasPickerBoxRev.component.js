...
class SinarmasPickerBox extends Component {
  ...
  render () {
    const {meta, itemList = [], input, placeholder, labelKey, currentValue, pickerStyle = {}, arrowPickerStyle = {}, textPickerStyle = {}, labelText = '', isRemittance, isCurrency, isPurpose} = this.props;
