...
class Picker extends Component {
  ...
  renderItem = (option, i) => (
    <PickerItemIOS key={`option${i}`} value={option} label={option} />
  );
      ...
      <View>
        <Touchable style={styles.textBoxStyle} onPress={showModal}>
          <Text
            style={
              isSplitBillForm
                ? [styles.textStyleNew, textPickerStyle]
                : [styles.textStyle, textPickerStyle]
            }>
            {selectedValue}
          </Text>
          <SimasIcon
            ...
            style={
              isSplitBillForm
                ? [styles.arrowDownStyleNew, arrowPickerStyle]
                : [styles.arrowDownStyle, arrowPickerStyle]
            }
          />
        </Touchable>
