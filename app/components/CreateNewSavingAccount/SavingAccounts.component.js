...
class SavingAccounts extends React.Component {
  static propTypes = {
            ...
            <Touchable onPress={getConfirmation}>
              <View style={styles.row}>
                ...
                <View style={styles.infoContainer}>
                  ...
                  <View style={styles.pad2}>
                    <Text style={styles.balanceTxt}>{language.SERVICE__AVAILABLE_BALANCE} {currency === 'IDR' ? 'Rp' : currency} {currencyFormatter(availableBalance)}</Text>
                  </View>
                </View>
