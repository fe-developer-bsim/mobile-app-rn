...
import styles from './BillerTypeTwoConfirmation.style';
...
export default class BillerTypeThreeConfirmation extends Component {
  ...
  render () {
    const {accountNo = {}, handleSubmit,
      biller = {}, dataDetail = [], goToCoupon, couponUse, resData = {}, isUseSimas,
      showFavorite = noop, favoriteBill, removeFavorite, billerFavorite, isLogin,
