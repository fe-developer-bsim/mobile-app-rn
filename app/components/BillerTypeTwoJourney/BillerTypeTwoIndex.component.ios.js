...
import {cardVerticalSpacingStyle, headingLight} from '../../styles/common.styles';
...
import styles from './BillerTypeTwoIndex.style';
...
class BillerTypeTwoIndex extends Component {
  static propTypes = {
  ...
  render () {
    ...
    const subscriberNoText = language[generateLanguageGenericBiller(result(biller, 'billerPreferences.paymentSubscriberNoKey', ''))];
    const subscriberNoPlaceHolderText = language[generateLanguageGenericBillerPlaceHolder(result(biller, 'billerPreferences.paymentSubscriberNoKey', ''))];
        ...
        <View style={cardVerticalSpacingStyle}>
          <View style={styles.row}>
            ...
            <View>
              ...
              <Text style={[{fontFamily: 'Roboto'}]}>{billerName}</Text>
            </View>
          </View>
          ...
          <View>
            <View style={styles.row2}>
              ...
              <Touchable onPress={wrapMethodInFunction(handleSubmit)} disabled={invalid || submitting}>
...
export default BillerTypeTwoIndex;
