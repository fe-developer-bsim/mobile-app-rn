...
class Pay extends React.Component {
  ...
  renderHistory = ({item}) => {
    const {
      ...
      disabled, textKey = '', subtextKey = '', secondaryTextKey = '', isBiFast, dtActionName} = this.props;
    ...
    return (
      <SwipeRow swipeToOpenPercent={10} disableRightSwipe={true} rightOpenValue={-54}>
        ...
        {
          isBiFast ?
            <Touchable dtActionName={dtActionName} onPress={onSelect(item)} disabled={disabled} style={styles.historyItem} highlightOpacity={1}>
