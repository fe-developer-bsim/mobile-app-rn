...
import styles from './BillerTypeTenConfirmation.style';
...
export default class BillerTypeTenConfirmation extends Component {
  static propTypes = {
  ...
  render () {
    const {accountNo = {}, resData = {}, dataDetail = [], isUseSimas,
      biller = {}, handleSubmit, goToCoupon, couponUse, showFavorite = noop,
      favoriteBill, removeFavorite, isLogin, billerFavorite, isNewBiller,
      isAutoDebit, autoDebitDate, isADebit} = this.props;
