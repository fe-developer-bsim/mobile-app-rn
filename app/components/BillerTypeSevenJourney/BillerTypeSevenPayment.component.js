...
import styles from './BillerTypeSevenPayment.styles';
...
class BillerTypeSevenPayment extends React.Component {
  static propTypes ={
  ...
  render () {
    const {formValues, billDetails = {}, invalid = false, handleSubmit = noop, denominations = [], billerAccount, billerAccountWithCC, isBillerBlacklisted, disabled, errors, defaultAccount, moreInfoBL, isLogin, isAutoSwitchToogle, switchAccountToogleBE, biller = {}, toogleCheckbox, checked, isAutoDebit, isADebit, autoDebitEnabled} = this.props;
    ...
    const creditBalance = result(formValues, 'accountNo.creditAvailable', '');
                  ...
                  { checkAcc ?
                    ...
                    <View style={{flex: 1}}>
                      ...
                      <View style={styles.row}>
                        ...
                        <Text style={[styles.balance, styles.roboto]}>{isEmpty(creditBalance) ? balance : creditBalance}</Text>
                      </View>
...
export default BillerTypeSevenPayment;