...
import {
  inquiryRecurringTransfer,
  checkTimeOperationRemittance,
} from '../state/thunks/fundTransfer.thunks';
    ...
    if (nameSearch === 'PREPAID') {
      ...
      dispatch(
        NavigationActions.navigate({
          ...
          params: {urlLink, singleBilingual},
        }),
      );
      ...
      dispatch(
        resetAndNavigate('ValidatePasswordBoarding', {
      ...
      dispatch(
        NavigationActions.navigate({
          ...
          params: {isSearch: true, nextRouteName: 'portofolio_mutualfund'},
        }),
      );
      ...
      dispatch(
        NavigationActions.navigate({
          routeName: 'InvestmentView',
          params: {isSearch: true, nextRouteName: 'portofolio_bancassurance'},
        }),
      );
      ...
      dispatch(
        isKyc
          ? actionCreators.saveProductCode('PD')
          : actionCreators.saveProductCode(''),
      );
      dispatch(
        isKyc
          ? getCurrentSectionAccountMenu()
