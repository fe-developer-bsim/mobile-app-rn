  ...
  componentDidMount() {
    ...
    BackHandler.addEventListener('backPress', () => {
      ...
      if (
        ...
        currentRoute === 'MigrateLandingPage' ||
        currentRoute === 'Login' ||
        currentRoute === ''
      ) {
      ...
      if (
        ['HomeScreen', 'AppVersionUpdator'].includes(currentRoute) ||
        showSpinner ||
        ...
        currentRoute === 'QRPaymentStatus' ||
        currentRoute === 'PaymentStatusNew' ||
        currentRoute === 'QRPaymentStatusRevamp' ||
        currentRoute === 'PaymentStatusRevamp' ||
...
const mapStateToProps = ({nav, showSpinner, appInitKeys}) => ({
  nav,
  showSpinner,
  appInitKeys,
});
