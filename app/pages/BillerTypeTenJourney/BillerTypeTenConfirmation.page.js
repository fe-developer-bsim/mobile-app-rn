...
const formConfig = {
  ...
  onSubmit: (values, dispatch, {denomination = {}, billAmount, navigation, amount, isPrepaidBiller, payBill, currentAmount, confirmData, isLogin, isSyariah, couponCheck, autoDebitDate}) => {
...
class BillerTypeTenConfirmationPage extends React.Component {
  ...
  payBill = () => {
    const {payGenericBillTypeTen, isLogin, navigation, isUseSimas, isAutoDebit, setAsAutodebit, autoDebitDate} = this.props;
